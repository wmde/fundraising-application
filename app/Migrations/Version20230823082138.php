...
final class Version20230823082138 extends AbstractMigration {
	...
	public function up( Schema $schema ): void {
		$table = $schema->createTable( 'legacy_authentication_tokens' );
		...
		$table->addColumn( 'update_token_expiry', 'datetime', [ 'nullable' => false ] );
	...
	public function down( Schema $schema ): void {
		$schema->dropTable( 'legacy_authentication_tokens' );
	}
}
