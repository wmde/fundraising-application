...
/**
 * @covers WMDE\Fundraising\Frontend\PaymentContext\Domain\CalculatingPaymentDelayCalculator
 *
 * @licence GNU GPL v2+
 * @author Kai Nissen < kai.nissen@wikimedia.de >
 */
class CalculatingPaymentDelayCalculatorTest extends \PHPUnit\Framework\TestCase {

	const PAYMENT_DELAY_IN_DAYS = 45;

	public function testCalculatorAddsIntervalToGivenDate() {
		$calculator = new CalculatingPaymentDelayCalculator( self::PAYMENT_DELAY_IN_DAYS );
