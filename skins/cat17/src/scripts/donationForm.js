  ...
  WMDE.StoreUpdates.connectComponentsToStore(
    [
      ...
      WMDE.Components.createBankDataComponent( store, {
		...
		WMDE.Components.makeTextComponentMoreSnappy( WMDE.Components.createValidatingTextComponent( store, $( '#first-name' ), 'firstName' ) ),
		WMDE.Components.makeTextComponentMoreSnappy( WMDE.Components.createValidatingTextComponent( store, $( '#last-name' ), 'lastName' ) ),
		WMDE.Components.makeTextComponentMoreSnappy( WMDE.Components.createValidatingTextComponent( store, $( '#company-name' ), 'companyName' ) ),
		WMDE.Components.makeTextComponentMoreSnappy( WMDE.Components.createValidatingTextComponent( store, $( '#street' ), 'street' ) ),
		WMDE.Components.makeTextComponentMoreSnappy( WMDE.Components.createValidatingTextComponent( store, $( '#adress-company' ), 'street' ) ),
		WMDE.Components.makeTextComponentMoreSnappy( WMDE.Components.createValidatingTextComponent( store, $( '#post-code' ), 'postcode' ) ),
		WMDE.Components.makeTextComponentMoreSnappy( WMDE.Components.createValidatingTextComponent( store, $( '#post-code-company' ), 'postcode' ) ),
		WMDE.Components.makeTextComponentMoreSnappy( WMDE.Components.createValidatingTextComponent( store, $( '#city' ), 'city' ) ),
		WMDE.Components.makeTextComponentMoreSnappy( WMDE.Components.createValidatingTextComponent( store, $( '#city-company' ), 'city' ) ),
