<template>
	<div>
		...
		<fieldset v-show="isAnon === 'no'" class="form-input form-input__option-list">
		...
		<h2 v-show="isAnon === 'no'" class="title is-size-5 has-margin-top-36">{{ $t( 'donation_form_section_address_header' ) }}</h2>
	</div>
</template>
