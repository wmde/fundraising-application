...
import { validateAmount, setAmount, setInterval, setOption, validatePayment } from '@/store/payment/actionTypes';
import {
	MARK_EMPTY_AMOUNT_SELECTION_INVALID,
	SET_AMOUNT_VALIDITY,
	SET_AMOUNT,
	SET_INTERVAL, SET_OPTION, MARK_EMPTY_FIELDS_INVALID,
...
export const actions = {
	...
	[ validatePayment ]( context: ActionContext<Payment, any> ): void {
		...
		if( !context.getters[ 'payment/amountIsValid' ] ) {
			context.commit( 'MARK_EMPTY_AMOUNT_INVALID', context.state.values.amount );
		}
	},
